...
- **PRÓXIMA ACCIÓN:** ninguna fase pendiente (Fase 5 = "solo con tracción"). Quedan: dominios/INAPI y la deuda viva del registro (AUD-005 sweep de ventana es la prioritaria si se retoma). ✅ Key SIP rotada (2026-07-09). ✅ Carpeta renombrada `ergia`→`acopia` (2026-07-11, verificación abajo).
