...
- **Observatorio rebanada 3 (enmienda ADR-012.2): CÓDIGO COMPLETO Y VERIFICADO CON DATOS REALES** (2026-07-15c, bitácora abajo): duck curve del CMg + valorización del desplazamiento a la punta. El bloqueo ("fuente de CMg automatizable") quedó obsoleto tras ADR-012.1 → la fuente es el caché `datos/cmg/` en el mismo ritual mensual local. Smoke con S.GREGORIO 2025 real: colapso a 29.7 USD/MWh a mediodía, punta 113 a las 22:00, **US$ 137 M** para los 2.463 GWh ene–may 2026 (η 85%, referencia declarada). **El sitio en vivo NO muestra esto aún**: falta poblar `datos/cmg/` (decisión del autor: publicar ya con CMg 2025 de S. Gregorio como referencia, o esperar el CMg 2026 de las 3 barras en agosto) y agregar los `--cmg` al paso de build del workflow.
- **PRÓXIMA ACCIÓN:** ver `## Próxima sesión` de `CLAUDE.md` (lista canónica renumerada 1–8). Titulares: ⏸ difundir el Observatorio (perfil de GitHub + LinkedIn, lo ejecuta el autor); refresco mensual (~agosto: ERV de junio **+ primer caché CMg** — XLS de las 3 barras representativas, ver pendiente 3); ⏸ decidir si la duck curve se publica ya con la referencia 2025; prospección Maule con el Observatorio como artefacto de venta. La postulación a Junior Data Engineer (Grupo Mariposa) sigue en curso; la oferta de pulir el dashboard para el CV queda abierta. ✅ Key SIP rotada (2026-07-09). ✅ Carpeta renombrada `ergia`→`acopia` (2026-07-11). ✅ Sweep de ventana + dashboard demo (2026-07-12).
...
- **OJO — el sitio en vivo no cambia todavía:** publicar la duck curve exige poblar `datos/cmg/` y agregar los `--cmg` al build del workflow. Decisión abierta del autor: publicar ya con la referencia 2025 (S. Gregorio solo) o esperar los XLS 2026 de las 3 barras en el refresco de agosto.
