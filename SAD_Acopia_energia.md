...
> Estructura: arc42 · **Versión: 1.3.1** (historial al final) · Estado: alcance de portafolio completo — fases 0–4 cerradas (sign-offs en [`docs/AUDIT.md`](./docs/AUDIT.md)); fase 5 solo con tracción; en curso: Observatorio (ADR-012), la cara pública
