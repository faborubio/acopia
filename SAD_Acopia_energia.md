...
> Estructura: arc42 · **Versión: 1.2.0** (historial al final) · Estado: alcance de portafolio completo — fases 0–4 cerradas (sign-offs en [`docs/AUDIT.md`](./docs/AUDIT.md)); fase 5 solo con tracción
