...
| AUD-028 | **La valorización a la punta usa la duck curve promedio de todo el período de referencia** (una curva por barra, enmienda ADR-012.2), no el calce mes a mes (vertimiento de enero × CMg de enero) ni día a día; además el año de referencia del CMg puede diferir del año del vertimiento (2025 vs 2026 hasta el refresco de agosto). Ambas cosas se declaran en el sitio. | Observatorio | Aceptada para la rebanada 3 — cuando `datos/cmg/` tenga los meses 2026, el calce mensual es la mejora natural (los agregados ya son puros; es agrupar por mes antes de promediar). |
